...
public class StoneJavelinEntity extends PersistentProjectileEntity {

    private static final TrackedData<Byte> LOYALTY = DataTracker.registerData(StoneJavelinEntity.class, TrackedDataHandlerRegistry.BYTE);
    private static final TrackedData<Boolean> ENCHANTED = DataTracker.registerData(StoneJavelinEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    private ItemStack javelinStack;
    private boolean dealtDamage;
    public int returnTimer;

    public StoneJavelinEntity(EntityType<? extends PersistentProjectileEntity> entityType, World world) {
        super(entityType, world);
        this.javelinStack = new ItemStack(ModItems.STONE_JAVELIN);
    }

    public StoneJavelinEntity(World world, LivingEntity owner, ItemStack stack) {
        super(ModEntities.STONE_JAVELIN_ENTITY, owner, world);
        this.javelinStack = new ItemStack(ModItems.STONE_JAVELIN);
